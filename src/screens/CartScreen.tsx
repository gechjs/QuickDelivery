...
import { ApplicationState, FoodModel, ShoppingState, onUpdateCart, createOrder, UserState } from '../redux'
...
const CartScreen = connect(mapStateToProps, { onUpdateCart, createOrder })(_CartScreen)
