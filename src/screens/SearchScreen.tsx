...
const _SearchScreen: React.FC<SearchScreenProps> = (props) => {
    ...
    const filteredFoods = useMemo(() => {
      if (!isEditing || !keyword) return availableFoods;
      return availableFoods.filter((item) => item.name.toLowerCase().includes(keyword.toLowerCase()));
    }, [availableFoods, keyword, isEditing]);
